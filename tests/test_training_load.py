...
def test_estimate_tss_with_hr_at_lthr() -> None:
    from training_load import _estimate_tss
...
def test_calculate_load_empty() -> None:
    from training_load import calculate_load_metrics
...
def test_weekly_km_trend_empty() -> None:
    from training_load import weekly_km_trend
...
def test_volume_spike_check_no_data() -> None:
    from training_load import volume_spike_check
