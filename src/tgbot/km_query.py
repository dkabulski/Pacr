...
VALID_SPORT_KEYS = set(SPORT_KEY_MAP) | {"all"}


def types_for_key(key: str) -> set[str] | None:
    """Return Strava type set for key, or None meaning 'all sports'."""
    return SPORT_KEY_MAP.get(key)
